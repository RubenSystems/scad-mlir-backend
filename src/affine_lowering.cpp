...
struct VectorOpLowering : public OpRewritePattern<scad::VectorOp> {
  ...
  LogicalResult matchAndRewrite(scad::VectorOp op,
...
namespace {
struct SCADToAffineLoweringPass
    : public PassWrapper<SCADToAffineLoweringPass, OperationPass<ModuleOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(SCADToAffineLoweringPass)
